...
<html>
                ...
                <nav>
                    <ul>
                        ...
                        <div class="dropdown-menu dropdownbtnoptions" aria-labelledby="dropdownMenuButton">
                          <a class="dropdown-item dropdownmenutext" href="#">Bikes</a>
    ...
    <div class="shop">
    <p2 class="specialized">Specialized</p2>
    <!-- Inner -->
        ...
        <div class="container">
            ...
            <div class="col-lg-4">
                ...
                <div class="card-body ">
                    ...
                    <a href="../learnmore/turbotero.php" class="btn btn-primary">Learn More</a>
                </div>
                </div>
            </div>
    ...
    <div class="carousel-inner py-4">
        ...
        <div class="container">
            ...
            <div class="col-lg-4">
                <div class="card">
                <img
                    src="../images/marlin.jpg"
                    class="card-img-top"
                    alt=""
                />
                <div class="card-body ">
                    <h5 class="card-title">Marlin 8 Gen 2</h5>
                    <p class="card-text">
            ...
            <div class="col-lg-4 d-none d-lg-block">
                ...
                />
                <div class="card-body">
                    <h5 class="card-title">Top Fuel 9.8 XT</h5>
                    <p class="card-text">
            ...
            <div class="col-lg-4 d-none d-lg-block">
                ...
                />
                <div class="card-body">
                    <h5 class="card-title">Fuel EXe 9.5</h5>
                    <p class="card-text">
